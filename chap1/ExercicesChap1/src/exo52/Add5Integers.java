...
public class Add5Integers {  // Save as "SumPrductMinMax3.java"
   public static void main (String[] args) {
     ...
     number3 = in.nextInt();
     System.out.print("Enter fourth integer: ");                    // Read next input as "int"
     number4 = in.nextInt();
     System.out.print("Enter fifth integer: ");                    // Read next input as "int"
     number5 = in.nextInt();
     in.close();
