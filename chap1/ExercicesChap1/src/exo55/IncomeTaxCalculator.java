...
public class IncomeTaxCalculator{
  public static void main(String[] args){
    ...
    taxableIncome = in.nextInt();  // read input as int
    in.close();
    ...
    if (taxableIncome <= 20000) {         // [0, 20000]
       ...
       taxPayable = (taxableIncome * 0.0) + ((taxableIncome - 20000) * TAX_RATE_ABOVE_20K);
    } else if (taxableIncome <= 60000) {  // [40001, 60000]
       taxPayable = (taxableIncome * 0.0) + (20000 * TAX_RATE_ABOVE_20K) + ((taxableIncome - 40000) * TAX_RATE_ABOVE_40K);
    } else {                              // [60001, ]
       taxPayable = (taxableIncome * 0.0) + (20000 * TAX_RATE_ABOVE_20K) + (20000 * TAX_RATE_ABOVE_40K) + ((taxableIncome - 60000) * TAX_RATE_ABOVE_60K);
    }
    ...
    int limit = 1000;
    taxPayable -= ((taxPayable * 0.1 ) > limit ? limit : 0);
